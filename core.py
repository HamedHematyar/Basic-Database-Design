    ...
    def filter(self, *arg, **filters):
        ...
        for record in self.records:
            for attr in record.keys():
                ...
                if filters[attr].lower() != record.get(attr).lower():
                    continue
...
if __name__ == '__main__':
    ...
    db.add(name='alex', phone='(+1)605-556-1235', address='2550 Marine Way Ave')

    # testing double entry
    db.add(name='alex', phone='(+1)605-556-1235', address='2550 Marine Way Ave')

    db.add(name='chan', phone='(+1)554-636-6870', address='857 Patterson Ave')
    db.add(name='martin', phone='(+1)778-686-6970', address='2150 West Ave')
